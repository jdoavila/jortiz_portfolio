...
export const SKILLS = [
  { name: "HTML & CSS", icon: "bx-code-alt", level: 90 },
  { name: "JavaScript", icon: "bxl-javascript", level: 85 },
  { name: "ReactJS", icon: "bxl-react", level: 80 },
  { name: "NextJS", icon: "bxl-react", level: 80 }, // Using React icon as placeholder
  { name: "Python", icon: "bxl-python", level: 90 },
  { name: "Django", icon: "bxl-django", level: 85 },
  { name: "TensorFlow", icon: "bx-brain", level: 60 },
  { name: "Git", icon: "bxl-git", level: 90 },
];
