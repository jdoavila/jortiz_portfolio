      ...
      <div className="container mb-6 w-full px-6 py-16 md:py-10" id="contact">
        <div className="mx-auto grid w-full grid-cols-1 gap-8 sm:w-3/4 md:gap-10 lg:w-full lg:grid-cols-2">
          <div className="mx-auto text-center">
            ...
            <p className="pt-2 text-base font-light text-gray-700 dark:text-slate-300">
            ...
            <div className="pt-8">
              <a
                ...
                className="inline-flex items-center justify-center rounded-md border border-transparent bg-slate-500 px-5 py-3 text-base font-medium text-white hover:bg-slate-600 dark:bg-slate-700 dark:hover:bg-slate-600"
              >
                Send me a message
              </a>
            </div>
